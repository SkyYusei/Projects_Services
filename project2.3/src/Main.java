...
public class Main {
	...
	static {
		...
		instances[0] = new DataCenterInstance("first_instance", "http://ec2-54-210-237-245.compute-1.amazonaws.com");
		instances[1] = new DataCenterInstance("second_instance", "http://ec2-54-210-237-80.compute-1.amazonaws.com");
		instances[2] = new DataCenterInstance("third_instance", "http://ec2-54-210-237-192.compute-1.amazonaws.com");
	}
